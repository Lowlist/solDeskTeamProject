...
let areas = [
    { temp: 0 , name: "서울", coordinates: new naver.maps.LatLng(37.5650477,126.9790563) },
    { temp: 0 , name: "수원", coordinates: new naver.maps.LatLng(37.2623618,127.0291814) },
    { temp: 0 , name: "춘천", coordinates: new naver.maps.LatLng(37.8842593,127.7300748) },
    { temp: 0 , name: "강릉", coordinates: new naver.maps.LatLng(37.7517044,128.8760003) },
    { temp: 0 , name: "대전", coordinates: new naver.maps.LatLng(36.3501703,127.3851213) },
    { temp: 0 , name: "청주", coordinates: new naver.maps.LatLng(36.6358372,127.4915513) },
    { temp: 0 , name: "전주", coordinates: new naver.maps.LatLng(35.8197508,127.1085748) },
    { temp: 0 , name: "광주", coordinates: new naver.maps.LatLng(35.1596238,126.8515119) },
    { temp: 0 , name: "대구", coordinates: new naver.maps.LatLng(35.8706793,128.6020288) },
    { temp: 0 , name: "부산", coordinates: new naver.maps.LatLng(35.1796902,129.0751275) },
    { temp: 0 , name: "태백", coordinates: new naver.maps.LatLng(37.1632469,128.9861211) },
    { temp: 0 , name: "진주", coordinates: new naver.maps.LatLng(35.2127259,128.1219777) },
    { temp: 0 , name: "제주", coordinates: new naver.maps.LatLng(33.4986998,126.5317497) }
];
areaCoord ={
    //상주(센터용)
...
$(document).ready(function(){
    ...
    // 센터메뉴 link로직
    $('.home-center-top-box').click(function(){
        let headerId = $(this).attr('id');
        //중기기상정보
        if(headerId=="homeCenterTopBox5"){
            window.location.href = '/spring/Weather/MediumWeather';
        //단기기상정보
        }else if(headerId=="homeCenterTopBox6"){
            window.location.href = '/spring/Weather/ShortWeather';
        //전국미세먼지
        }else if(headerId=="homeCenterTopBox7"){
            window.location.href = '/spring/Weather/DustWeather';
        //생활기상지수
        }else if(headerId=="homeCenterTopBox8"){
            window.location.href = '/spring/Weather/LivingWeather';
        //과거날씨정보(ASOS)
        }else if(headerId=="homeCenterTopBox10"){
            window.location.href = 'https://weather.naver.com/warning/09680115';
        //사이트소개
        }else if(headerId=="homeCenterTopBox3"){
            window.location.href = 'https://youtu.be/dQw4w9WgXcQ';
        }
    });
    ...
    for (let i = 0; i < jsonDataArray.length; i++) {
        if (jsonDataInfo[i].response.header.resultCode == "00") {
            for (let a = 0; a < jsonDataInfo[i].response.body.items.item.length; a++) {
                ...
                // //대기지수
                // if (jsonDataInfo[i].response.body.items.item[a].category == "SKY") {
                //     if (jsonDataInfo[i].response.body.items.item[a].fcstDate == nowDate()) {
                //         let abc = jsonDataInfo[i].response.body.items.item[a].fcstTime;
                //         if (abc == "0700") {
                //             let a = jsonDataInfo[i].response.body.items.item[a].fcstValue;
                //         }
                //     }
                // }
            }
...
function cssForMap(){
    ...
    for(i = 0;i<=12;i++){
        $('.home-center-right-map').append("<div class=mini-weather-info id=miniWeather"+i+"></div>");
    }
