	...
	<div class="main-living">
        ...
        <div class="main-living-center-line">
            <div class="living-center-left-line">
                <div class="living-center-left-box-line">
                	<div class="living-center-top-box" id="livingCenterTopBox"></div>
                </div>
                <div class="living-center-left-small-box-line">
                    <div class="living-center-left-small-box" id="livingCenterSmallBox"></div>
                </div>
            </div>
