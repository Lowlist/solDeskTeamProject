...
function livingDataRun(){
    ...
    for(i = 0 ; i < arrays.length ; i++,z++){
        ...
        if(z < 5 || z >= 10 && z <= 15 || z <= 15 && z >= 20 || z == 20 || z <= 30 && z >= 35 || z == 30 || z <= 40 && z >= 35){
            z = z + 5;
        }

        if(z == 7 || z == 12 || z == 17 || z == 22 || z == 27){
            z = z + 1;
        }

        $('#livingInfoWord'+z).append(
            '<div class=living-word> <div class=living-word-hour id="livingHour">' +
            c +'</div><div class=living-word-UV>'+arrays[i]+'</div><div class=living-word-air>'+arrays[i]+'</div></div>'
        );
        console.log(z);
        a = a + 3;
    }
...
function cssForLiving(){
    ...
    $('#livingInfoWord2 , #livingInfoWord12 , #livingInfoWord22 , #livingInfoWord32 , #livingInfoWord42 , #livingInfoWord52').text('2024-04-19');
