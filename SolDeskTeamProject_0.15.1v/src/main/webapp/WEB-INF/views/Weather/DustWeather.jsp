...
<body>
	...
	<div class="dust-main">
		...
		<div class="dust-center-line">
			...
			<div class="dust-center-content-left">
				...
				<div class="dust-center-content-main">
					<div class="dust-center-content-span-left-line">
						<div class="span-left">
							<img src="../resources/img/prevbutton.png" class="prev"/>
						</div>
					</div>
					<div class="dust-center-content-main-area"
						...
						<c:forEach var="i" begin="0"
							...
							<div class="item" id="item${i}"
								...
								data-inform-code="${items.get(i).informCode}"
								></div>
						</c:forEach>
					</div>
					<div class="dust-center-content-span-right-line">
						<div class="span-right">
							<img src="../resources/img/nextbutton.png" class="next"/>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="dust-center-right-line">
