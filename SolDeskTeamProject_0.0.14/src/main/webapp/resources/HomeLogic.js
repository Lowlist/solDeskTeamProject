...
function changeArea(){
    console.log(addressData.area1);
    if(addressData.area1 == "서울특별시"){
        return addressData.area5 = "서울";
    }else if(addressData.area1 == "경기도" && addressData.area2 == "수원시"){
        return addressData.area5 = "수원";
    }else if(addressData.area1 == "강원특별자치도" && addressData.area2 == "춘천시"){
        return addressData.area5 = "춘천";
    }else if(addressData.area1 == "강원특별자치도" && addressData.area2 == "강릉시"){
        return addressData.area5 = "강릉";
    }else if(addressData.area1 == "강원특별자치도" && addressData.area2 == "태백시"){
        return addressData.area5 = "태백";
    }else if(addressData.area1 == "대전광역시"){
        return addressData.area5 = "대전";
    }else if(addressData.area1 == "충청북도" && addressData.area2 =="청주시"){
        return addressData.area5 = "청주";
    }else if(addressData.area1 == "전북특별자치도" && addressData.area2 =="전주시"){
        return addressData.area5 = "전주";
    }else if(addressData.area1 == "광주광역시"){
        return addressData.area5 = "광주";
    }else if(addressData.area1 == "대구광역시"){
        return addressData.area5 = "대구";
    }else if(addressData.area1 == "부산광역시"){
        return addressData.area5 = "부산";
    }else if(addressData.area1 == "경상남도" && addressData.area2 == "진주시"){
        return addressData.area5 = "진주";
    }else if(addressData.area1 == "제주특별자치도"){
        return addressData.area5 = "제주";
    }
}
...
function changeAddress(latlng) {
    ...
    naver.maps.Service.reverseGeocode({
        ...
        //변환된 주소데이터 저장
        console.log(response.v2.address.jibunAddress);
...
function jsonDataLogic(jsonData) {
    ...
    // 형바주보
function changeInfo(){
    let intTMN = parseInt(WeatherData.dataTMN);
    let intTMX = parseInt(WeatherData.dataTMX);
    ...
    if (clickBoolean) {
        ...
        if (intTMN >= -200 && intTMX >= -200) {
            if(mapBtnResult == 0){
                for(i=0;i<12;i++){
                    $('#miniWeather'+i).text(addressData.area5+WeatherData.dataTMP);
                }
            }else if(mapBtnResult == 1){
                for(i=0;i<12;i++){
                    $('#miniWeather'+i).text(addressData.area5+WeatherData.dataTMN);
                }
            }else if(mapBtnResult == 2){
                for(i=0;i<12;i++){
                    $('#miniWeather'+i).text(addressData.area5+WeatherData.dataTMX);
                }
            }
        }
    }
...
function areaCoordRun(){
    return areaCoord={
        ...
        //태백
        taebaek: new naver.maps.LatLng(37.1632469,128.9861211),
        //진주
        jinju: new naver.maps.LatLng(35.2127259,128.1219777),
        //제주도
