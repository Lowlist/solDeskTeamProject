					...
					<div class="dust-center-content-main-area">
						<c:forEach var="i" begin="0"
							...
							<div class="item" id="item${i}"
								data-image-url1="${dust.response.body.items.get(i).imageUrl1}"
								data-image-url2="${dust.response.body.items.get(i).imageUrl2}"
								data-image-url3="${dust.response.body.items.get(i).imageUrl3}"
								data-image-url4="${dust.response.body.items.get(i).imageUrl4}"
								data-image-url5="${dust.response.body.items.get(i).imageUrl5}"
								data-image-url6="${dust.response.body.items.get(i).imageUrl6}"
								data-inform-data="${dust.response.body.items.get(i).informData}"
								data-data-time="${dust.response.body.items.get(i).dataTime}"
								data-inform-grade="${dust.response.body.items.get(i).informGrade}">
							</div>
						</c:forEach>
					</div>
